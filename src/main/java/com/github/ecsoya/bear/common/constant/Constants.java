...
public class Constants {
	 ...
	 */
	public static final String[] JSON_WHITELIST_STR = { "org.springframework", "com.github.ecsoya.bear" };

	/**
	 * 定时任务白名单配置（仅允许访问的包名，如其他需要可以自行添加）
	 */
	public static final String[] JOB_WHITELIST_STR = { "com.github.ecsoya.bear.framework.task" };
